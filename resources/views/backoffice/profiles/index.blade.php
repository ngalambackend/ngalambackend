...
<section class="section">
    ...
    <div class="section-body">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <form method="POST" action="{{ route('backoffice.profile.update') }}">
            @csrf @method('PUT')
            <div class="card">
            <div class="card-header">
                <h4>Information</h4>
            ...
            <div class="card-body">
                ...
                <div class="col-sm-6 col-md-9">
                    <input type="text" name="name" value="{{ $profile->name }}" class="form-control  @error('name') is-invalid @enderror" id="name">
                    @error('name')
                ...
                <div class="col-sm-6 col-md-9">
                    <input type="email" name="email" value="{{ $profile->email }}" class="form-control @error('email') is-invalid @enderror" id="email">
                    @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
